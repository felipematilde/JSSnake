...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _parameters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parameters */ \"./parameters.js\");\n/* harmony import */ var _snake__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snake */ \"./snake.js\");\n/* harmony import */ var _startHelpScreen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./startHelpScreen */ \"./startHelpScreen.js\");\n/* harmony import */ var _square__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./square */ \"./square.js\");\n/* harmony import */ var _gameScore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gameScore */ \"./gameScore.js\");\n\n\n\n\n //Start Help Screen\n\nvar startHelpScreen = new _startHelpScreen__WEBPACK_IMPORTED_MODULE_2__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenWidth\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenHeight\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenColor\"], (_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaWidth\"] / 2 - _parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenWidth\"] / 2) / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], (_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"] / 2 - _parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenHeight\"] / 2) / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"startHelpScreenBorder\"]); //GameArea\n\nvar gameArea = new _square__WEBPACK_IMPORTED_MODULE_3__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaWidth\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaColor\"], 0, 0, _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaBorder\"]); //Snake\n\nvar snake = new _snake__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\"down\");\nstartHelpScreen.addObserver(snake);\nsnake.addScreenObserver(startHelpScreen); //Fruit\n\nvar fruit = new _square__WEBPACK_IMPORTED_MODULE_3__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"fruitColor\"], 10, 20);\nsnake.addFruitObserver(fruit); //GameScore\n\nvar gameScore = new _gameScore__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\nsnake.addScoreObserver(gameScore); //Credits\n\nvar credits = document.createElement(\"output\");\ncredits.style.position = \"absolute\";\ncredits.style.top = _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"] + 5;\ncredits.style.left = 5;\ncredits.value = \"Developed by: Felipe Matilde\";\ndocument.body.appendChild(credits);\ndocument.addEventListener(\"keydown\", function (event) {\n  //Read input\n  //  Prevent turnback and eat it own\n  var key = event.key,\n      keyCode = event.keyCode;\n\n  if ((key.toUpperCase() === \"W\" || keyCode == \"38\") && snake.direction !== \"down\") {\n    snake.direction = \"up\";\n  } else if ((key.toUpperCase() === \"S\" || keyCode == \"40\") && snake.direction !== \"up\") {\n    snake.direction = \"down\";\n  } else if ((key.toUpperCase() === \"D\" || keyCode == \"39\") && snake.direction !== \"left\") {\n    snake.direction = \"right\";\n  } else if ((key.toUpperCase() === \"A\" || keyCode == \"37\") && snake.direction !== \"right\") {\n    snake.direction = \"left\";\n  } //Pause\n\n\n  if (key.toUpperCase() === \"P\") {\n    startHelpScreen.pausePlay();\n  } //Restart\n\n\n  if (key.toUpperCase() === \"R\") {\n    startHelpScreen.startStop();\n  }\n});\nstartHelpScreen.stop(); //Game loop\n\nsetTimeout(gameLoop(), snake.snakeSpeed);\n\nfunction gameLoop() {\n  if (!startHelpScreen.gameOver && !startHelpScreen.gameIsOnPause) {\n    snake.move();\n  }\n\n  setTimeout(gameLoop, snake.snakeSpeed);\n}\n\n//# sourceURL=webpack:///./main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Snake; });\n/* harmony import */ var _parameters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parameters */ \"./parameters.js\");\n/* harmony import */ var _square__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./square */ \"./square.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Snake = /*#__PURE__*/function () {\n  //Attributes:\n  //   direction;\n  //   body;\n  //   listScoreObserver;\n  //   listFruitObserver;\n  //   listScreeObserver;\n  //   snakeSpeed;\n  function Snake(direction) {\n    _classCallCheck(this, Snake);\n\n    this.direction = direction; //\"down\", \"up\", \"left\", \"right\"\n    //Snake body\n\n    var head = new _square__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeHeadColor\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"]);\n    var piece1 = new _square__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeColor\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 1);\n    var piece2 = new _square__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeColor\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 2);\n    var piece3 = new _square__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeColor\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 3);\n    this.body = [head, piece1, piece2, piece3];\n    this.listScoreObserver = [];\n    this.listFruitObserver = [];\n    this.listScreenObserver = [];\n    this.snakeSpeed = _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeInitialSpeed\"];\n  }\n\n  _createClass(Snake, [{\n    key: \"addScoreObserver\",\n    value: function addScoreObserver(scoreObserver) {\n      this.listScoreObserver.push(scoreObserver);\n    }\n  }, {\n    key: \"addFruitObserver\",\n    value: function addFruitObserver(fruitObserver) {\n      this.listFruitObserver.push(fruitObserver);\n    }\n  }, {\n    key: \"addScreenObserver\",\n    value: function addScreenObserver(screenOserver) {\n      this.listScreenObserver.push(screenOserver);\n    }\n  }, {\n    key: \"move\",\n    value: function move() {\n      var length = this.body.length; //Body mouvement\n\n      for (var i = 1; i < length; i++) {\n        var _x = this.body[length - i - 1].x,\n            _y = this.body[length - i - 1].y;\n        this.body[length - i].setXY(_x, _y);\n      } //Head mouvement\n\n\n      var x = this.body[0].x,\n          y = this.body[0].y;\n\n      if (this.direction === \"up\") {\n        this.body[0].setXY(x, y - 1);\n      } else if (this.direction === \"down\") {\n        this.body[0].setXY(x, y + 1);\n      } else if (this.direction === \"right\") {\n        this.body[0].setXY(x + 1, y);\n      } else if (this.direction === \"left\") {\n        this.body[0].setXY(x - 1, y);\n      } //When snake is outside gameArea\n\n\n      x = this.body[0].x, y = this.body[0].y;\n\n      if (this.body[0].x < 0) {\n        this.body[0].setXY(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaWidth\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] - 1, y);\n      } else if (this.body[0].x > _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaWidth\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] - 1) {\n        this.body[0].setXY(0, y);\n      } else if (this.body[0].y < 0) {\n        this.body[0].setXY(x, _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] - 1);\n      } else if (this.body[0].y > _parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] - 1) {\n        this.body[0].setXY(x, 0);\n      }\n\n      this.checkSnakeEatFruit();\n      this.checkSnakeEatSnake();\n    }\n  }, {\n    key: \"increaseSpeed\",\n    value: function increaseSpeed() {\n      this.snakeSpeed = this.snakeSpeed * 0.90;\n    }\n  }, {\n    key: \"resetSnake\",\n    value: function resetSnake() {\n      var length = this.body.length;\n      this.snakeSpeed = _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeInitialSpeed\"];\n\n      for (var i = 1; i < length - 3; i++) {\n        this.body[length - i].removeDiv();\n        this.body.splice(length - i);\n      }\n\n      this.body[0].setXY(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"]);\n      this.body[1].setXY(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 1);\n      this.body[2].setXY(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 2);\n      this.body[3].setXY(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialX\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"initialY\"] - 3);\n      this.direction = \"down\";\n    }\n  }, {\n    key: \"findRandomPosition\",\n    value: function findRandomPosition() {\n      var fruit = this.listFruitObserver[0];\n      var fruitIsOnSnake = true;\n      var x, y;\n\n      while (fruitIsOnSnake) {\n        fruitIsOnSnake = false;\n        x = Math.floor(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaWidth\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] * Math.random());\n        y = Math.floor(_parameters__WEBPACK_IMPORTED_MODULE_0__[\"gameAreaHeight\"] / _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"] * Math.random());\n        this.body.forEach(function (item) {\n          if (x === item.x && y === item.y) fruitIsOnSnake = true;\n        });\n      }\n\n      fruit.setXY(x, y);\n    }\n  }, {\n    key: \"checkSnakeEatFruit\",\n    value: function checkSnakeEatFruit() {\n      var length = this.body.length;\n      var x = this.body[length - 1].x,\n          y = this.body[length - 1].y;\n      var fruit = this.listFruitObserver[0]; //Snake eat fruit\n\n      if (this.body[0].x === fruit.x && this.body[0].y === fruit.y) {\n        var snakeNewPiece = new _square__WEBPACK_IMPORTED_MODULE_1__[\"default\"](_parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeSize\"], _parameters__WEBPACK_IMPORTED_MODULE_0__[\"snakeColor\"], x, y);\n        this.body.push(snakeNewPiece);\n        this.findRandomPosition(); //fruit new position\n\n        this.listScoreObserver[0].increaseScore();\n        this.increaseSpeed();\n      }\n    }\n  }, {\n    key: \"checkSnakeEatSnake\",\n    value: function checkSnakeEatSnake() {\n      var length = this.body.length;\n      var snakeEatSnake = false; //Snake eat snake\n\n      for (var i = 1; i < length; i++) {\n        if (this.body[0].x === this.body[i].x && this.body[0].y === this.body[i].y) {\n          snakeEatSnake = true;\n        }\n      }\n\n      if (snakeEatSnake) {\n        this.listScoreObserver[0].resetScore();\n        this.listScreenObserver[0].stop();\n        this.resetSnake();\n      }\n    }\n  }]);\n\n  return Snake;\n}();\n\n\n\n//# sourceURL=webpack:///./snake.js?");
